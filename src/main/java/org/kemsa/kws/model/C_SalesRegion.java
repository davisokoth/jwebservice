...
public class C_SalesRegion implements Serializable {
    ...
    public C_SalesRegion() {
    }

    public C_SalesRegion(Long cSalesregionId) {
        this.id = cSalesregionId;
    }

    public C_SalesRegion(Long cSalesregionId, long adClientId, long adOrgId, char isactive, Date created, long createdby, Date updated, long updatedby, String value, String name, char issummary, char isdefault) {
        this.id = cSalesregionId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof C_SalesRegion)) {
            return false;
        }
        C_SalesRegion other = (C_SalesRegion) object;
    ...
    public String toString() {
        return "org.kemsa.codegenproject.CSalesRegion[ cSalesregionId=" + id + " ]";
    }
